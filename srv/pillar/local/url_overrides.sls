...
urls:
    ...
    nomad: http://fileserver.maurusnet.test/downloads/nomad/nomad_1.0.3_linux_amd64.zip
    nomad-autoscaler: http://fileserver.maurusnet.test/downloads/nomad-autoscaler/nomad-autoscaler_0.2.1_linux_amd64.zip
    ...
    vault: http://fileserver.maurusnet.test/downloads/vault/vault_1.6.2_linux_amd64.zip
