...
urls:
    ...
    consul: http://fileserver.maurusnet.test/downloads/consul/consul_1.10.3_linux_amd64.zip
    ...
    nomad: http://fileserver.maurusnet.test/downloads/nomad/nomad_1.1.6_linux_amd64.zip
    ...
    terraform: http://fileserver.maurusnet.test/downloads/terraform/terraform_1.0.10_linux_amd64.zip
    vault: http://fileserver.maurusnet.test/downloads/vault/vault_1.8.5_linux_amd64.zip
