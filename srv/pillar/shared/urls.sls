...
urls:
    concourse: https://github.com/concourse/concourse/releases/download/v3.5.0/concourse_linux_amd64
    ...
    terraform: https://releases.hashicorp.com/terraform/0.10.6/terraform_0.10.6_linux_amd64.zip
