...
urls:
    concourse: https://github.com/concourse/concourse/releases/download/v1.5.1/concourse_linux_amd64
    ...
    nomad: https://releases.hashicorp.com/nomad/0.4.0/nomad_0.4.0_linux_amd64.zip
