...
urls:
    ...
    concourse-fly: https://github.com/concourse/concourse/releases/download/v5.0.1/fly-5.0.1-linux-amd64.tgz
    consul: https://releases.hashicorp.com/consul/1.5.0/consul_1.5.0_linux_amd64.zip
