...
urls:
    ...
    consul: https://releases.hashicorp.com/consul/1.19.1/consul_1.19.1_linux_amd64.zip
    ...
    consul-template: https://releases.hashicorp.com/consul-template/0.39.0/consul-template_0.39.0_linux_amd64.zip
    nomad: https://releases.hashicorp.com/nomad/1.8.1/nomad_1.8.1_linux_amd64.zip
    nomad-autoscaler: https://releases.hashicorp.com/nomad-autoscaler/0.4.4/nomad-autoscaler_0.4.4_linux_amd64.zip
    nomad-pack: https://releases.hashicorp.com/nomad-pack/0.1.2/nomad-pack_0.1.2_linux_amd64.zip
    terraform: https://releases.hashicorp.com/terraform/1.9.2/terraform_1.9.2_linux_amd64.zip
    vault: https://releases.hashicorp.com/vault/1.17.2/vault_1.17.2_linux_amd64.zip
