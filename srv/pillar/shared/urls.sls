...
urls:
    ...
    consul: https://releases.hashicorp.com/consul/1.15.0/consul_1.15.0_linux_amd64.zip
    ...
    consul-template: https://releases.hashicorp.com/consul-template/0.30.0/consul-template_0.30.0_linux_amd64.zip
    nomad: https://releases.hashicorp.com/nomad/1.5.0/nomad_1.5.0_linux_amd64.zip
    ...
    terraform: https://releases.hashicorp.com/terraform/1.3.9/terraform_1.3.9_linux_amd64.zip
    vault: https://releases.hashicorp.com/vault/1.13.0/vault_1.13.0_linux_amd64.zip
